...
const PatientMasterUpdate = ({
  ...
  useEffect(() => {
    console.log("Fetcheddata", updatedata);
    setUserdata(updatedata);
  }, []);
  console.log("Statevariabledata", Userdata);
  ...
  const handleupdate = async (updateid) => {
    const updatedataref = doc(db, "PatientMaster", updateid);
    try {
    ...
    <>
      <Box
        ...
        sx={{
          ...
          // width: "100%",
          // height: "79%",
          width: { xs: "100%", sm: "75vh", md: "75vh", lg: "100%" }, // Make it more flexible on small screens
      ...
      >
        ...
        >
          <Grid2 item size={10.5} container sx={{ justifyContent: "end" }}>
            <Typography
            ...
            >
              Patient Master Update
            </Typography>
          </Grid2>

          <Grid2 item container size={1.5} sx={{ justifyContent: "end" }}>
            <IconButton
              sx={{
...
export default PatientMasterUpdate;
