...
function TestcreationDailogupdate({
  handleCloseupdate,
  updatedata,
  updateid,
  refreshList,
  ...
  const handleupdate = async (updateid) => {
    const updatedataref = doc(db, "TestMaster", updateid);
    try {
    ...
    <>
      <Box
        ...
        sx={{
          ...
          // height: { xs: "70vh", sm: "70vh", md: "100%", lg: "70%" },
      ...
      >
        ...
        >
          <Grid2 item container size={10.3} sx={{ justifyContent: "end" }}>
            <Typography
              //   align="center"
          ...
          <Grid2 item container size={1.7} sx={{ justifyContent: "end" }}>
            <IconButton
              sx={{
...
export default TestcreationDailogupdate;
